...
def print_death_age(people_dict):
	...
	for i in people_dict:
		print(f"{people_dict[i][NAME_INDEX]} {people_dict[i][DEATH_YEAR_INDEX] - people_dict[i][BIRTH_YEAR_INDEX]} ({people_dict[i][BIRTH_YEAR_INDEX]} - {people_dict[i][DEATH_YEAR_INDEX]})")
...
def count_genders(people_dict):
	...
	females = 0
	for i in people_dict:
		if people_dict[i][GENDER_INDEX] == "M":
			males += 1
		else:
			females += 1
...
def print_marriages(marriages_dict, people_dict):
	...
	for i in marriages_dict:
		print(f"{people_dict[marriages_dict[i][HUSBAND_KEY_INDEX]][NAME_INDEX]} {marriages_dict[i][WEDDING_YEAR_INDEX]-people_dict[marriages_dict[i][HUSBAND_KEY_INDEX]][BIRTH_YEAR_INDEX]} > {marriages_dict[i][WEDDING_YEAR_INDEX]} < {people_dict[marriages_dict[i][WIFE_KEY_INDEX]][NAME_INDEX]} {marriages_dict[i][WEDDING_YEAR_INDEX]-people_dict[marriages_dict[i][WIFE_KEY_INDEX]][BIRTH_YEAR_INDEX]}")
